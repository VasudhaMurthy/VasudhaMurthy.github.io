    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Right side: Resume button + menu toggle */}
          <div className="flex items-center space-x-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 px-3 py-1.5 rounded-lg text-white font-semibold transition-colors text-sm"
              aria-label="Open Resume PDF in new tab"
            >
              <FileText size={18} />
              Resume
