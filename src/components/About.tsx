            ...
            <div className="flex flex-col lg:flex-row gap-8 items-center">
              <div className="lg:w-2/3">
                <p className="text-lg text-gray-300 leading-relaxed text-justify">
                  I'm Vasudha—a curious builder who loves turning ideas into simple, thoughtful solutions. 
                  I enjoy collaborating, solving real problems, and learning something new with every project.
                </p>
                <p className="text-lg text-gray-300 leading-relaxed text-justify mt-6">
                  I work mostly with Python, and love building smooth user experiences with React.js 
                  and Kotlin on web and Android. Clean code, good design, and real-world impact keep me going.
